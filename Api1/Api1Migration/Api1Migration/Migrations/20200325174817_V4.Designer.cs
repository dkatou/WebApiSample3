...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Api1.Api1Model.Models.Person", b =>
                {
                    ...
                    b.Property<string>("PersonFirstName")
                        .HasColumnName("N_PERSON_FIRST_NAME")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("PersonLastName")
                        .HasColumnName("N_PERSON_LAST_NAME")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasKey("PersonId", "PersonFirstName", "PersonLastName");

                    b.ToTable("T_PERSON");
                });

            modelBuilder.Entity("Api1.Api1Model.Models.PersonTask", b =>
                {
                    b.Property<int>("PersonChargeId")
                        .HasColumnName("V_PERSON_CHARGE_ID")
                        .HasColumnType("int");

                    b.Property<string>("TaskId")
                        .HasColumnName("V_TASK_ID")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasKey("PersonChargeId", "TaskId");

                    b.ToTable("T_PERSON_TASK");
                });
            ...
            modelBuilder.Entity("Api1.Api1Model.Models.CompanyChild", b =>
                {
                    b.HasOne("Api1.Api1Model.Models.Company", "CompanyC")
                        .WithMany("CompanyChildChilds")
                        .HasForeignKey("CompanyChildId")
            ...
            modelBuilder.Entity("Api1.Api1Model.Models.PersonTask", b =>
                {
                    b.HasOne("Api1.Api1Model.Models.Person", "Person")
                        .WithMany("PersonTasks")
                        .HasForeignKey("PersonChargeId")
